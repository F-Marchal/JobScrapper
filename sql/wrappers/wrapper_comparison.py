...
class ComparisonWrapper(ClauseElementWrapper):
    ...
    @property
    def op(self) -> Callable[[Column, Any], ClauseElement]:
        return self._op

    @op.setter
    def op(self, operator:  Callable[[Column, Any], ClauseElement]):
        self._op = operator
...
STRING_TO_COMPARISON_WRAPPERS: dict[str, ComparisonWrapper] = {s: cw for cw in COMPARISON_WRAPPERS for s in cw.symbols}
